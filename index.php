        ...
        <div class="hero-grid">
            <div class="hero-left">
                ...
                <div class="premium-search-container reveal-right" style="max-width: 36rem; margin-bottom: 1.5rem; animation-delay: 0.5s;">
                    ...
                    <form action="<?php echo SITE_URL; ?>/browse.php" method="GET">
                ...
                <div class="popular-tags reveal-right" style="justify-content: flex-start; margin-bottom: 2rem; animation-delay: 0.6s;">
                    ...
                    <a href="<?php echo SITE_URL; ?>/browse.php?q=Web+Design" class="tag">Web Design</a>
                    <a href="<?php echo SITE_URL; ?>/browse.php?q=WordPress" class="tag">WordPress</a>
                    <a href="<?php echo SITE_URL; ?>/browse.php?q=Logo+Design" class="tag">Logo Design</a>
                </div>
...
<section class="categories-section" id="categories">
    ...
    <div class="container">
        ...
        <div class="categories-grid">
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Development" class="category-card">
            ...
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Design" class="category-card">
                <div class="category-icon">
            ...
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Writing" class="category-card">
                <div class="category-icon">
            ...
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Video+Animation" class="category-card">
                <div class="category-icon">
            ...
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Marketing" class="category-card">
                <div class="category-icon">
            ...
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Translation" class="category-card">
                <div class="category-icon">
            ...
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Music+Audio" class="category-card">
                <div class="category-icon">
            ...
            <a href="<?php echo SITE_URL; ?>/browse.php?category=Photography" class="category-card">
                <div class="category-icon">
    ...
    <div class="container">
        ...
        <div class="steps-grid">
            ...
            <div class="step-card">
                ...
                <h3 class="step-title">Hire with Confidence</h3>
                <p class="step-description">
                    Review portfolios, ratings, and past work. Place your order with secure escrow-style protection.
                </p>
            </div>
        ...
        <div class="f-grid">
            <div class="f-bento-card large">
                ...
                <div class="relative z-10">
                    ...
                    <a href="<?php echo SITE_URL; ?>/browse.php" class="f-btn-premium" style="text-decoration: none; display: inline-block;">Explore Solutions</a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="cta-box">
            ...
            <p class="cta-description">
                Join thousands of freelancers and businesses building something great together.
            </p>
            <div class="cta-actions">
                <a href="<?php echo SITE_URL; ?>/register.php?role=freelancer" class="btn btn-lg" style="background: var(--card); color: var(--foreground);">
                    Join as Seller
                    <i class="fas fa-arrow-right"></i>
                </a>
                <a href="<?php echo SITE_URL; ?>/browse.php" class="btn btn-outline btn-lg" style="border-color: rgba(255,255,255,0.3); color: white;">
                    Find Services
                </a>
            </div>
        </div>
