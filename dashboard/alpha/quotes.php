                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                ...
                                <div class="text-muted" style="font-size: 0.75rem;"><?php echo htmlspecialchars($quote['email']); ?></div>
                            </td>
                            <td class="px-4 py-3 small text-muted"><?php echo htmlspecialchars($quote['service_type']); ?></td>
                            <td class="px-4 py-3 small text-success fw-bold"><?php echo htmlspecialchars($quote['budget_range']); ?></td>
                            <td class="px-4 py-3">
                                <span class="badge bg-success bg-opacity-10 text-success px-2 py-1" style="font-size: 0.65rem;">CONTACTED</span>
                            </td>
                            <td class="px-4 py-3 text-end">
                                <button class="btn btn-light btn-sm rounded-3 border" data-bs-toggle="modal" data-bs-target="#quoteModal-<?php echo $quote['id']; ?>">
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5 text-muted">No quote requests found.</td>
                        </tr>
                        <?php endif; ?>
                        </tbody>
                </table>
