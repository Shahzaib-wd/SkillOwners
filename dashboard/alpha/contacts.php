                    ...
                    <table class="table table-hover mb-0">
                        <thead class="bg-light">
                            <tr>
                                ...
                                <th class="px-4 py-3 small text-uppercase fw-bold text-muted">Subject</th>
                        ...
                        <tr>
                            <td class="px-4 py-3">
                                <div class="fw-bold small"><?php echo htmlspecialchars($contact['full_name']); ?></div>
                                <div class="text-muted" style="font-size: 0.75rem;"><?php echo htmlspecialchars($contact['email']); ?></div>
                            </td>
                            <td class="px-4 py-3 small text-muted"><?php echo htmlspecialchars($contact['service_interest'] ?: 'General'); ?></td>
                            <td class="px-4 py-3 small fw-500"><?php echo htmlspecialchars($contact['subject']); ?></td>
                            <td class="px-4 py-3">
                                    ...
                                    <div class="modal-body p-4">
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                ...
                                                <p class="fw-bold mb-0"><?php echo htmlspecialchars($contact['full_name']); ?></p>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <h6 class="fw-bold"><?php echo htmlspecialchars($contact['subject']); ?></h6>
                                            </div>
                                            <div class="col-12">
