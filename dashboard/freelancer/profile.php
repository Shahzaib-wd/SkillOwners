        ...
        <div class="row">
                ...
                <div class="dashboard-card">
                    <form method="POST" action="<?php echo SITE_URL; ?>/dashboard/update_profile.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label font-weight-500 mb-2">Professional Title</label>
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label font-weight-500 mb-2">Professional Bio</label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label font-weight-500 mb-2">Skills (comma separated)</label>
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label font-weight-500 mb-2">Portfolio Website</label>
            ...
            <div class="col-lg-4">
                ...
                <div class="dashboard-card" style="border-top: 4px solid var(--primary);">
                    <h4 class="h6 font-weight-500 mb-2">Need Help?</h4>
